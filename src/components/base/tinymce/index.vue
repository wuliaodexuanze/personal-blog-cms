...
export default {
  ...
  created() {
    const _this = this
    const fpg = this.fullpage ? 'fullpage' : ''
    this.tinymceInit = {
      ...
      // eslint-disable-next-line
      plugins: `print ${fpg} searchreplace autolink directionality visualblocks visualchars template codesample charmap hr pagebreak nonbreaking anchor toc insertdatetime wordcount textpattern help advlist table lists paste preview fullscreen image imagetools code link`,
