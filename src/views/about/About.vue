    ...
    <div class="lin-info">
      ...
      <div class="lin-info-right">
        <div class="team-detail">
          <div class="team-box">
            <div class="team-title">博主信息</div>
            <ul class="team-ul">
              <li>
                <span class="shadow-box">
                  <i class="team-shadow"></i>
                </span>
                <span class="team-role">昵称</span>
                <span class="team-name">手里有糖（javafs）</span>
              </li>
              <li>
                <span class="shadow-box">
                  <i class="team-shadow"></i>
                </span>
                <span class="team-role">邮箱</span>
                <span class="team-name">1169655050@qq.com</span>
              </li>
              <li>
                <span class="shadow-box">
                  <i class="team-shadow"></i>
                </span>
                <span class="team-role">居住地</span>
                <span class="team-name">成都</span>
              </li>
            </ul>
          </div>
          <div class="team-icon">
